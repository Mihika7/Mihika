...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Mihika7/Mihika/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/K,Mihika7/Mihika/master/requirements.txt
#Start Fumkin
